...
class MarketStubTest {
    ...
    def TestMarketOrder() {
        ...
        stub.submitOrders(new Order(OrderType.Market, 0, qty, Side.Buy,"sec","id"))
        ...
        var sellQty = 2
        stub.submitOrders(new Order(OrderType.Market, 0, sellQty, Side.Sell,"sec","id1"))
    ...
    def TestLimitOrderPriceBetterThanMarket() = {
        ...
        var qty = 2
        stub.submitOrders(new Order(OrderType.Limit, 3, qty, Side.Buy,"sec","id"))
        ...
        var sellQty = 2
        stub.submitOrders(new Order(OrderType.Limit, 1, sellQty, Side.Sell,"sec","id1"))
