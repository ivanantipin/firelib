...
import firelib.backtest.{IModel, ModelConfig}
import firelib.writers.TradesCsvWriter

import scala.collection.immutable.HashMap


object ReportWriter {
    def Write(model: IModel, cfg: ModelConfig, targetDir: String) = {

        JsonSerializerUtil.Save(cfg, Path.Combine(targetDir, "cfg.json"));
